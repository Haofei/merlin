  ...
  return (
    <div data-testid="help-modal">
      ...
      <div>
        ...
        <a href="https://github.com/Haofei/merlin" target="_blank" rel="noopener noreferrer">
          <span>View on GitHub</span>
        </a>
        <a href="mailto:yuesefa@gmail.com">
...
describe('HelpModal', () => {
  ...
  it('contains the correct link to the GitHub repository', () => {
    ...
    expect(githubLink).toHaveAttribute('href', 'https://github.com/Haofei/merlin');
  });

  it('contains the correct link to send an email', () => {
    render(<HelpModal {...defaultProps} />);
    const emailLink = screen.getByText('Send Email').closest('a');
    expect(emailLink).toHaveAttribute('href', 'mailto:yuesefa@gmail.com');
  });
});
